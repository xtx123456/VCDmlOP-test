...
def main():
    ...
    # Partially-labeled adversary AUX (per "Provenance of Training without Training Data")
    ap.add_argument('--labeled-frac', type=float, default=0.10,
                    help='Fraction of attacker AUX that has labels (default: 0.10)')
    ...
    argv = [
        ...
        '--lambda-ce', str(args.lambda_ce),
        '--lambda-ce-end', str(args.lambda_ce_end),
        '--lr', str(args.lr),
